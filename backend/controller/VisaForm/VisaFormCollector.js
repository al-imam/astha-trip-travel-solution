        ...
        schengen: async (req, res) => {
            ...
            try {
                ...
                const resdb = await Schengen.Add({
                    ...
                    address_of_inviting_company_org: body["name-address-of-inviting-company"],
                    phone_of_inviting_company_org: body["telephone-no-of-inviting-company"],
                    contact_person_of_inviting_company: body["surname-and-first-name-of-contact-persons"],
                    cost_of_travel_and_living: JSON.stringify(body["cost-of-traveling-and-living"]),
